% Version to be used with Matlab older than R2014a
...
timit_folder='/nfsmnt/shinefs0/data/misc/TIMIT'; % Path of the original close-talk TIMIT dataset
...
for i=1:length(list)
 ...
 wavwrite(0.95.*signal_rev_noise,16000,name_wav)
