...
if [ -f $data/segments ]; then
  ...
  pitch_feats="ark,s,cs:compute-kaldi-pitch-feats --verbose=2 --config=$pitch_config scp,p:$logdir/wav_${name}.JOB.scp ark:- | process-kaldi-pitch-feats --add-delta-pitch=false $postprocess_config_opt ark:- ark:- |"
